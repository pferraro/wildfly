...
public class DatabaseDataStoreAdd extends AbstractAddStepHandler {
    ...
    public void installRuntimeServices(final OperationContext context, final ModelNode operation, final ModelNode model) throws OperationFailedException {
        ...
        context.getServiceTarget().addService(serviceName, databaseTimerPersistence)
                .addDependency(Services.JBOSS_SERVICE_MODULE_LOADER, ModuleLoader.class, databaseTimerPersistence.getModuleLoaderInjector())
                .addDependency(ContextNames.bindInfoFor(jndiName).getBinderServiceName(), ManagedReferenceFactory.class, databaseTimerPersistence.getDataSourceInjector())
                .addDependency(TimerServiceDeploymentProcessor.TIMER_SERVICE_NAME, java.util.Timer.class, databaseTimerPersistence.getTimerInjector())
                .addDependency(ServerEnvironmentService.SERVICE_NAME, ServerEnvironment.class, databaseTimerPersistence.getServerEnvironmentInjector())
                .install();
    }
