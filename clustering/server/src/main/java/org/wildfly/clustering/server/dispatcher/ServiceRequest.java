...
public class ServiceRequest<T> extends UnicastRequest<T> {
    ...
    public boolean complete(T value) {
        return (value instanceof NoSuchService) ? super.completeExceptionally(new CancellationException()) : super.complete(value);
    }

    @Override
    public boolean completeExceptionally(Throwable exception) {
        return (exception instanceof SuspectedException) ? super.completeExceptionally(new CancellationException()) : super.completeExceptionally(exception);
    }
}
