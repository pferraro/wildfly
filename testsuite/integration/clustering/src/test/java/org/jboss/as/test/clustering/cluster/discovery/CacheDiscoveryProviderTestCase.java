...
import static org.jboss.as.test.clustering.cluster.discovery.service.CacheDiscoveryServiceActivator.*;
...
import org.jboss.as.test.clustering.cluster.discovery.service.CacheDiscoveryServiceActivator;
...
@ServerSetup(CacheDiscoveryProviderTestCase.ServerSetupTask.class)
public class CacheDiscoveryProviderTestCase extends AbstractClusteringTestCase {

    private static final String MODULE_NAME = CacheDiscoveryProviderTestCase.class.getSimpleName();
    private static final String DEPLOYMENT_NAME = MODULE_NAME + ".war";

    public static class ServerSetupTask extends CLIServerSetupTask {
        public ServerSetupTask() {
            this.builder.node(TWO_NODES)
                    .setup("/subsystem=discovery/cache-provider=%s:add(cache-container=server)", REGISTRY_PROVIDER_NAME)
                    .teardown("/subsystem=discovery/cache-provider=%s:remove()", REGISTRY_PROVIDER_NAME)
                    ;
        }
    }
    ...
    private static Archive<?> getDeployment() {
        ...
        archive.addClasses(DiscoveryServlet.class, CacheDiscoveryServiceActivator.class, DiscoveryServiceActivator.class);
        archive.setManifest(new StringAsset("Manifest-Version: 1.0\nDependencies: org.jboss.as.server, org.wildfly.discovery, org.wildfly.clustering.discovery.spi\n"));
        ...
        archive.addAsServiceProvider(ServiceActivator.class, CacheDiscoveryServiceActivator.class);
        return archive;
    }
    ...
    public void test(
        ...
        URI registerURI2 = DiscoveryServlet.createURI(baseURL1, REGISTRY_PROVIDER_NAME, baseURL2);
