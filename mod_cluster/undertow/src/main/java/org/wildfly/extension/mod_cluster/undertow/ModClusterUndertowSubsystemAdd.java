...
public class ModClusterUndertowSubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, ModelNode model, ServiceVerificationHandler verificationHandler, List<ServiceController<?>> newControllers) throws OperationFailedException {
        ...
        final ModelNode modelConfig = fullModel.get(ModClusterUndertowExtension.SUBSYSTEM_PATH.getKeyValuePair());
        final String connector = ModClusterUndertowResourceDefinition.LISTENER.resolveModelAttribute(context, modelConfig).asString();
        ...
        newControllers.add(target.addService(SERVICE_NAME, new UndertowEventHandlerAdapter(eventHandler, undertowService, listener))
                ...
                .addDependency(UndertowService.listenerName(connector), ListenerService.class, listener) // TODO this is wrong, it should be replaced with injecting server instead of directly listener
