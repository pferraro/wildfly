...
public class ModClusterUndertowExtension implements Extension {
    ...
    public static final String NAMESPACE = "urn:jboss:domain:modcluster-undertow:1.0";
    ...
    public void initialize(final ExtensionContext context) {
        ModClusterUndertowLogger.ROOT_LOGGER.debug("Activating mod_cluster Undertow Integration Extension");
        ...
        subsystem.registerXMLElementWriter(ModClusterUndertowParser_1_0.INSTANCE);
    }

    @Override
    public void initializeParsers(final ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ModClusterUndertowExtension.NAMESPACE, ModClusterUndertowParser_1_0.INSTANCE);
    }
